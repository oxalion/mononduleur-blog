...
<div id="core" class="container">
	<div class="row">
		...
		<div <?php post_class(); ?>>
                ...
                <div class="meta">
                        <!-- <?php the_time('j/m/y') ?> &bull; -->
                        Catégories <?php the_category(', ') ?> &bull; 
                        <?php comments_popup_link('Aucun Commentaire', '1 Commentaire', '% Commentaires'); ?> &bull; 
                        <a href="<?php the_permalink(); ?>"><?php _e('Lire plus','themnific');?> &#187;</a>
                </div> 
	...
	<?php endwhile; else: ?>
		...
		<p><?php _e('Aucun article ne correspond.','themnific');?>.</p>
